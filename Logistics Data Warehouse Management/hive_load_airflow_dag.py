...
create_hive_database = DataprocSubmitHiveJobOperator(
    ...
    cluster_name='dataproccluster',
    region='us-east1',
    project_id='portfolio-project-414217',
    dag=dag
)
...
create_hive_table = DataprocSubmitHiveJobOperator(
    ...
    query="""
        ...
        STORED AS TEXTFILE
        LOCATION 'gs://logistics-raw-as/input_data'
...
archive_processed_file = BashOperator(
    ...
    bash_command=f"gsutil -m mv gs://logistics-raw-as/input_data/logistics_*.csv gs://logistics-archive-as/",
    dag=dag
)
